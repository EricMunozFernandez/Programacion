...
public class VentanaAcontecimientos extends javax.swing.JFrame {
    ...
    public VentanaAcontecimientos(Acontecimiento ac) {
        ...
        // Conversiones de date a localDate y localTime
        // LocalDate fechaNueva = fechaAntigua.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        dpFecha.setDate(ac.getFecha().toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
     /*
        Date time = ...;
        Instant instant = Instant.ofEpochMilli(time.getTime());
        LocalTime res = LocalDateTime.ofInstant(instant, ZoneId.systemDefault()).toLocalTime();
        */
        Instant instant = Instant.ofEpochMilli(ac.getHoraInicio().getTime());
        LocalTime res = LocalDateTime.ofInstant(instant, ZoneId.systemDefault()).toLocalTime();
        tpHoraInicio.setTime(res);
        
        instant = Instant.ofEpochMilli(ac.getHoraFin().getTime());
        res = LocalDateTime.ofInstant(instant, ZoneId.systemDefault()).toLocalTime();
        tpHoraFin.setTime(res);
        
        Integer aforo = (Integer) ac.getAforo();
        tffAforo.setText(aforo.toString());
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(dpFecha, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
